...
public class UniqueClothes {
    ...
    public UniqueClothes(Integer id, Integer category, String name, Integer price, Integer discount, Integer saled, List<String> color, List<Integer> size, String imgPath, String location, String colorTemp, String sizeTemp) {
