...
public class ClothesServiceImpl implements IClothesService {
    ...
    @Override
    public List<IndexClothesResponse> getAllIndexClothes() {
        return clothesdao.getAllIndexClothes();
    }
    ...
    public UniqueClothes getUniqueClothes(Integer id) {
        ...
        uniqueClothes.setComments(this.getUniqueClothesComments(id));
     ...
     */
    @Override
    public Integer getUniqueClothesComments(Integer id) {
        return clothesdao.getUniqueClothesComments(id);
    }
}
