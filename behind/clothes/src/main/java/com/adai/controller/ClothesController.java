...
public class ClothesController {
     ...
     * @return .
     */
    @RequestMapping(value = "getAllIndexClothes", method = RequestMethod.GET)
    private ActionResponse getAllIndexClothes() {
        List<IndexClothesResponse> allIndexClothes = clothesService.getAllIndexClothes();
        return ActionResponse.success(allIndexClothes);
    }
